...
dyn_error_t m_add_scaled_column(m_t* src, size_t src_col_idx, m_data_t src_scale, m_t* dest, size_t dest_col_idx);
...
dyn_error_t m_scalar_multiply(m_t* src, m_data_t multiplyer, m_t* dest);
